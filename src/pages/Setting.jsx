...
export default function Setting() {
  ...
  const [form, setForm] = useState({
    ...
    currency: {
      defaultAccountCurrency: "NGN",
      enableBalanceConversion: false,
      conversionTargetCurrency: "NGN",
    },
    accountManagement: {
      defaultTransferAccount: "",
      autoSaveToSavings: false,
  ...
  return (
    <div className="container mx-auto p-4 space-y-6 max-w-4xl">
            ...
            <div className="form-control">
              <label className="label cursor-pointer">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setField(
                      "security.requirePinForTransfers",
                      e.target.checked,
                    )
                  }
                />
            ...
            <div className="form-control">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="font-bold min-w-[120px]">
                  ₦{form.security.dailyTransferLimit.toLocaleString()}
                </span>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="form-control">
              ...
              <select
                ...
                onChange={(e) =>
                  setField("preferences.language", e.target.value)
                }
              >
            ...
            <div className="form-control">
              ...
              <select
                ...
                onChange={(e) =>
                  setField("preferences.currency", e.target.value)
                }
              >
        ...
        <div className="card-body">
          ...
          <div className="space-y-4">
            ...
            <div className="form-control">
              <label className="label cursor-pointer">
                <span className="label-text font-medium">
                  Only Allow Saved Beneficiaries
                </span>
                <input
                  type="checkbox"
                  className="toggle toggle-primary"
                  ...
                  onChange={(e) =>
                    setField(
                      "payments.allowedBeneficiariesOnly",
                      e.target.checked,
                    )
                  }
                />
      ...
      <div className="card bg-base-100 shadow-lg">
        <div className="card-body">
          <h2 className="card-title text-xl mb-4">Currency Settings</h2>
          <div className="space-y-4">
            <div className="form-control">
              <label className="label">
                <span className="label-text font-medium">
              ...
              <select
                className="select select-bordered w-full max-w-xs"
                value={form.currency.defaultAccountCurrency}
                onChange={(e) =>
                  setField("currency.defaultAccountCurrency", e.target.value)
                }
              >
                <option value="NGN">NGN (₦)</option>
                <option value="USD">USD ($)</option>
            ...
            <div className="form-control">
              <label className="label cursor-pointer">
                <span className="label-text font-medium">
                  Enable Balance Conversion
                </span>
                <input
                  type="checkbox"
                  className="toggle toggle-primary"
                  checked={form.currency.enableBalanceConversion}
                  onChange={(e) =>
                    setField(
                      "currency.enableBalanceConversion",
                      e.target.checked,
                    )
                  }
                />
              ...
              <p className="text-sm text-gray-600 mt-1">
                Automatically convert all account balances to the target
                currency.
              </p>
            </div>

            {form.currency.enableBalanceConversion && (
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-medium">
                ...
                <select
                  className="select select-bordered w-full max-w-xs"
                  value={form.currency.conversionTargetCurrency}
                  onChange={(e) =>
                    setField(
      ...
      <div className="card bg-base-100 shadow-lg">
        <div className="card-body">
          <h2 className="card-title text-xl mb-4">Account Management</h2>
          <div className="space-y-4">
            <div className="form-control">
              <label className="label">
                <span className="label-text font-medium">
              ...
              <input
                className="input input-bordered w-full max-w-md"
                value={form.accountManagement.defaultTransferAccount}
                onChange={(e) =>
                  setField(
                    "accountManagement.defaultTransferAccount",
                    e.target.value,
                  )
                }
                placeholder="Enter account ID (e.g., main or savings)"
              />
            </div>
            ...
            <div className="form-control">
              <label className="label cursor-pointer">
                ...
                <input
                  type="checkbox"
                  className="toggle toggle-primary"
                  checked={form.accountManagement.autoSaveToSavings}
                  onChange={(e) =>
                    setField(
                      "accountManagement.autoSaveToSavings",
                      e.target.checked,
                    )
                  }
                />
              ...
              <p className="text-sm text-gray-600 mt-1">
                Automatically transfer a percentage of deposits to savings
                account.
              </p>
            </div>

            {form.accountManagement.autoSaveToSavings && (
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-medium">
                ...
                <div className="flex items-center gap-4">
                  <input
                    ...
                    max="50"
                    step="1"
                    value={form.accountManagement.autoSavePercentage}
                    onChange={(e) =>
                      setField(
                        "accountManagement.autoSavePercentage",
                        Number(e.target.value),
                      )
                    }
                    className="range range-primary flex-1"
                  ...
                  <span className="font-bold min-w-[60px]">
                    {form.accountManagement.autoSavePercentage}%
                  </span>
                </div>
              </div>
            )}
            ...
            <div className="form-control">
              ...
              <input
                ...
                min="0"
                step="100"
                value={form.accountManagement.lowBalanceAlert}
                onChange={(e) =>
                  setField(
                    "accountManagement.lowBalanceAlert",
                    Number(e.target.value),
                  )
                }
